...
#Name of the job
#SBATCH --job-name=lincsConcatNPC
#SBATCH -N 1
...
#Define sdout path
#SBATCH --output=/home/users/gsantamaria/projects/brain_clock/scripts/lincs_obtain/output_concat_parsed_lincs_files_NPC.txt
#Define sderr path
#SBATCH --error=/home/users/gsantamaria/projects/brain_clock/scripts/lincs_obtain/error_concat_parsed_lincs_files_NPC.txt
