...
#Name of the job
#SBATCH --job-name=NEAT_enr_mDEGsUpGO
#SBATCH -N 1
...
#Define sdout path
#SBATCH --output=/home/users/gsantamaria/projects/brain_clock/scripts/func_enrich/output_NEAT_enrich_mDEGsUpGO.txt
#Define sderr path
#SBATCH --error=/home/users/gsantamaria/projects/brain_clock/scripts/func_enrich/error_NEAT_enrich_mDEGsUpGO.txt
...
outNameNEAT="mice_DEGs_up_neat_GO.csv"
extGeneSets=NULL
FCVersion=5
conv2ENSEMBL=false
