...
#Name of the job
#SBATCH --job-name=lincsParseMICR
#SBATCH -N 1
...
#Define sdout path
#SBATCH --output=/home/users/gsantamaria/projects/brain_clock/scripts/lincs_obtain/output_lincs_parse_MICROGLIA.txt
#Define sderr path
#SBATCH --error=/home/users/gsantamaria/projects/brain_clock/scripts/lincs_obtain/error_lincs_parse_MICROGLIA.txt
...
########################################################################################################################
gctxDir="/mnt/lscratch/users/gsantamaria/test_large_files/MICROGLIA-PSEN1/gctx/"
