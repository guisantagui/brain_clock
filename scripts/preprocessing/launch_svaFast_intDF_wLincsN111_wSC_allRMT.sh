...
# etc. Determination of number of SVs with RMT.
...
nSV_method="RMT"
#rinFilt=6
outDir="/home/users/gsantamaria/projects/brain_clock/results/preprocessing/integ_LINCSSamps_wSC_all_sva_fast_allLINCSBrainRMT/"
