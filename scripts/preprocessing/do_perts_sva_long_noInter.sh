...
#Name of the job
#SBATCH --job-name=perts_preproc_lng_noInt
#SBATCH -N 1
...
#Define sdout path
#SBATCH --output=/home/users/gsantamaria/projects/brain_clock/scripts/preprocessing/output_perts_preproc_lng_noInt.txt
#Define sderr path
#SBATCH --error=/home/users/gsantamaria/projects/brain_clock/scripts/preprocessing/error_perts_preproc_lng_noInt.txt
...
nSV_method="leek"
nPCs=20
outDir="../../results/preproc/perts_preproc_lng_noInt/"
