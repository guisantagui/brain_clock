...
#Name of the job
#SBATCH --job-name=perts_preproc_rmt
#SBATCH -N 1
...
#Define sdout path
#SBATCH --output=/home/users/gsantamaria/projects/brain_clock/scripts/preprocessing/output_perts_preproc_rmt.txt
#Define sderr path
#SBATCH --error=/home/users/gsantamaria/projects/brain_clock/scripts/preprocessing/error_perts_preproc_rmt.txt
...
nSV_method="RMT"
nPCs=20
outDir="../../results/preproc/perts_preproc_rmt/"
