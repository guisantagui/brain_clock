...
#Define sdout path
#SBATCH --output=/home/users/gsantamaria/projects/brain_clock/scripts/output_svaFastAllNoAge_lincsLndmrk.txt
#Define sderr path
#SBATCH --error=/home/users/gsantamaria/projects/brain_clock/scripts/error_svaFastAllNoAge_lincsLndmrk.txt
...
nSV_method="leek"
#rinFilt=6
outDir="/home/users/gsantamaria/projects/brain_clock/results/preprocessing/integ_LINCSSamps_wSC_all_sva_fast_noAge_allLINCSBrain/"
...
Rscript sva_fast_exe.R $noCerebFile --mod $mod0_onlyAge --mod0 $mod0_onlyAge --nSV_method $nSV_method --saveSVrem --outDir $outDir &
