...
#Name of the job
#SBATCH --job-name=svaFastNoLINCSsignChrn
#SBATCH -N 1
...
filtDF="/home/users/gsantamaria/projects/brain_clock/results/models/modAllGenes_integ_and_sc_noLINCS_sva_chron_age/modFuncsAlpha1_coefs.csv" # "none" for not filtering
#propZerosRem=0.8
nPCs=20
...
nSV_method="leek"
#rinFilt=6
outDir="/home/users/gsantamaria/projects/brain_clock/results/preprocessing/integ_LINCSSamps_wSC_all_sva_fast_excldLINCS_filtSignChron/"
