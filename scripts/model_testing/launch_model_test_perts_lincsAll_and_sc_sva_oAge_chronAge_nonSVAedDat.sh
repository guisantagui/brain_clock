...
#Name of the job
#SBATCH --job-name=modTstPrtsNonSVAed
#SBATCH -N 1
...
#Define sdout path
#SBATCH --output=/home/users/gsantamaria/projects/brain_clock/scripts/model_test_perts/output_model_test_pertsNonSVAed.txt
#Define sderr path
#SBATCH --error=/home/users/gsantamaria/projects/brain_clock/scripts/model_test_perts/error_model_test_pertsNonSVAed.txt
...
mem="50G"
outDir="/home/users/gsantamaria/projects/brain_clock/results/model_test_perts/modAllGenes_integWLincs_and_sc_oAge_chronAge_alph1_onNonSVAedDat/"
